...
- **Tirar dados**: cada caracteristica tiene su propio boton 🎲. La tirada es 2d6 + la caracteristica elegida + una experiencia elegida (puede quedar vacia) + 1d6 extra si se gasta 1 punto de Guapura. Muestra un cartel con el detalle de la tirada y el resultado, y le avisa a todos los demas conectados (GM y jugadores) con una notificacion de Owlbear. Con mas de 12 se gana 1 punto de Guapura.
