...
- Reglas opcionales (las activa el GM desde una pantalla de Opciones):
  ...
  - El dado de Guapura no cuenta para ganarla: si se usa el d6 extra de Guapura en una tirada, ese dado no cuenta
    para decidir si se gana 1 punto de Guapura por sacar mas de 12.
